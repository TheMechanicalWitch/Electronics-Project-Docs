...
\authorOne{Adam Nyberg}{studentEmail@student.mdh.se}
\authorTwo{Adrian Swande}{studentEmail@student.mdh.se}
\authorThree{Ashley Björs}{studentEmail@student.mdh.se}
\authorFour{Cornelia Wahlman}{studentEmail@student.mdh.se}
\authorFive{Filip Kopkin}{studentEmail@student.mdh.se}
\authorSix{Samuel Andersson}{studentEmail@student.mdh.se}
\authorSeven{Whiliam Borglund}{studentEmail@student.mdh.se}
